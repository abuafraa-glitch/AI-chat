...
_FAILOVER_CONFIGURED = bool(os.environ.get("FAILOVER_TEST_HOST"))
HOST = os.environ.get("FAILOVER_TEST_HOST", "http://localhost:8000")
pytestmark = pytest.mark.skipif(
    not _FAILOVER_CONFIGURED,
    reason="Operational failover tests require explicit FAILOVER_TEST_HOST",
)
