...
_SECURITY_CONFIGURED = bool(os.environ.get("SECURITY_TEST_HOST"))
HOST = os.environ.get("SECURITY_TEST_HOST", "http://localhost:8000")
pytestmark = pytest.mark.skipif(
    not _SECURITY_CONFIGURED,
    reason="Operational security tests require explicit SECURITY_TEST_HOST",
)
