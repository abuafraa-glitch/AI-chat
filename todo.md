...
- [ ] مراجعة Git status والـ commits الحالية قبل الرفع
- [ ] رفع Flutter إلى main وBackend إلى master دون أسرار أو APK
- [ ] فحص سجلات Backend وFlutter لمسار إرسال الرسالة وGroq/SSE
- [ ] إصلاح بقاء واجهة المحادثة في حالة جارِ التفكير ومعالجة أخطاء النقل
- [ ] إضافة أو تحديث اختبارات regression لمسار الرد
- [ ] بناء APK جديد مرتبط بالخادم العامل والتحقق منه
