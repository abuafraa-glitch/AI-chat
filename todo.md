...
- [ ] مراجعة تغييرات Flutter الجديدة وملفات البناء قبل رفعها إلى فرع main
- [ ] مراجعة تغييرات Backend الجديدة قبل رفعها إلى فرع master
- [ ] التأكد من عدم تضمين الأسرار أو ملفات APK داخل commits GitHub
- [ ] رفع Flutter إلى main وBackend إلى master
- [ ] التحقق من تطابق الفروع المحلية والبعيدة وتوثيق commit IDs
